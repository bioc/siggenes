sam2html<-function(object,delta,filename,addStats=TRUE,addPlot=TRUE,addGenes=TRUE,varName=NULL,
		entrez=TRUE,refseq=TRUE,symbol=TRUE,omim=FALSE,ug=FALSE,chipname="",
		cdfname=NULL,which.refseq="NM",refsnp=NULL,
	...
	siggenes2html(object,delta,filename,addStats=addStats,addPlot=addPlot,addGenes=addGenes,
		...
		text.col=text.col,link.col=link.col,plotArgs=plotArgs,which.refseq=which.refseq,
