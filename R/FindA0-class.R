...
setMethod("plot","FindA0",
	function(x,y,logit=TRUE,pos.legend=NULL,cexLegend=0.8,col=NULL,main=NULL,xlab=NULL,
		...
		if(pos.legend!=0){
			...
			legend(where,legend=textLegend,lty=lty,lwd=lwd,cex=cexLegend,col=col,
